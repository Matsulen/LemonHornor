package net.matsulen.lemonhornor.world;

import com.mojang.serialization.Codec;
import net.matsulen.lemonhornor.LemonHornor;
import net.matsulen.lemonhornor.world.structure.SkyStructures;
...
public class ModWorld {
     ...
     */
    public static final DeferredRegister<StructureType<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(Registries.STRUCTURE_TYPE, LemonHornor.MOD_ID);
    /**
