package net.matsulen.lkartifacts.world;

import com.mojang.serialization.Codec;
import net.matsulen.lkartifacts.LKArtifacts;
import net.matsulen.lkartifacts.world.structure.SkyStructures;
...
public class ModWorld {
     ...
     */
    public static final DeferredRegister<StructureType<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(Registries.STRUCTURE_TYPE, LKArtifacts.MOD_ID);
    /**
