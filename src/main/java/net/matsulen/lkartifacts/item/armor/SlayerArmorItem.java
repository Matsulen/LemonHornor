...
public class SlayerArmorItem extends AllArmorItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()){
            ...
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.slayer_armor.tooltip.control1").withStyle(ChatFormatting.LIGHT_PURPLE));
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.slayer_armor.tooltip.control2").withStyle(ChatFormatting.LIGHT_PURPLE));
