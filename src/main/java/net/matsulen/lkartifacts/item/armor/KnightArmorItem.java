...
public class KnightArmorItem extends AllArmorItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()){
            ...
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.knight_armor.tooltip.control1").withStyle(ChatFormatting.DARK_GRAY));
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.knight_armor.tooltip.control2").withStyle(ChatFormatting.DARK_GRAY));
