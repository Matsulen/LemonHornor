...
public class BambooSwordItem extends SwordItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()){
            ...
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.bamboo_sword.tooltip.control1").withStyle(ChatFormatting.DARK_GRAY));
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.bamboo_sword.tooltip.control2").withStyle(ChatFormatting.DARK_GRAY));
