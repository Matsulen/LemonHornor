...
public class ShapedAmethystItem extends SwordItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()){
            ...
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.shaped_amethyst.tooltip.shift2").withStyle(ChatFormatting.DARK_GRAY));
            pTooltipComponents.add(Component.translatable("tooltip.lkartifacts.shaped_amethyst.tooltip.shift3").withStyle(ChatFormatting.DARK_GRAY));
