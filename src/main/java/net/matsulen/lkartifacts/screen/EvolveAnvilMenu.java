...
public class EvolveAnvilMenu extends AbstractContainerMenu {
    ...
    //                                              玩家的背包        方块实体
    public EvolveAnvilMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.EVOLVE_ANVIL_MENU.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = ((EvolveAnvilBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.EVOLVE_ANVIL.get());
    }
