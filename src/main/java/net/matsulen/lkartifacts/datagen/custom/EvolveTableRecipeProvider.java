package net.matsulen.lkartifacts.datagen.custom;
...
public class EvolveTableRecipeProvider implements RecipeBuilder{
    ...
    public static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject pJson) {
            ...
            jsonarray.add(Ingredient.of(ingredient.getItems()[0]).toJson());
            jsonarray.add(Ingredient.of(ingredient.getItems()[1]).toJson());
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(LKArtifacts.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_fea");
        }

        @Override
        public RecipeSerializer<?> getType() {
            return EvolveAnvilRecipe.Serializer.INSTANCE;
        }
