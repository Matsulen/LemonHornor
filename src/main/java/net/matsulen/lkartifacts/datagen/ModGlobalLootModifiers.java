...
public class ModGlobalLootModifiers extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        if (ModList.get().isLoaded("dungeons_arise")) {
            addDungeonsAriseModifiers();
        }
        if (ModList.get().isLoaded("betterdungeons")) {
            addBetterDungeonsModifiers();
        }
        if (ModList.get().isLoaded("betterfortresses")) {
            addBetterFortressesModifiers();
        }
        if (ModList.get().isLoaded("betterwitchhuts")) {
            addBetterWitchhutsModifiers();
        }
        if (ModList.get().isLoaded("betterdeserttemples")) {
            addBetterDeserttemplesModifiers();
        }
        if (ModList.get().isLoaded("cataclysm")) {
            addCataclysmModifiers();
        }
        if (ModList.get().isLoaded("betterstrongholds")) {
            addBetterStrongholdsModifiers();
        }
        if (ModList.get().isLoaded("betteroceanmonuments")) {
            addBetterOceanmonumentsModifiers();
        }
    ...
    private void addBetterOceanmonumentsModifiers() {
        //==========================================================================================
    ...
    private void addBetterStrongholdsModifiers() {
        // ==========================================================================================
    ...
    private void addCataclysmModifiers() {
    ...
    private void addBetterDeserttemplesModifiers() {
        //=========================================================================
    ...
    private void addBetterWitchhutsModifiers() {
    ...
    private void addBetterFortressesModifiers() {
        //============================================================================================================
    ...
    private void addBetterDungeonsModifiers() {
